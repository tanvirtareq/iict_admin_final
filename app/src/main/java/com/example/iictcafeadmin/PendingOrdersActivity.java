    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        adapter = new FirebaseRecyclerAdapter<OrderDetails, DataViewHolder>(options) {
            ...
            protected void onBindViewHolder( DataViewHolder holder, int position, @NonNull final OrderDetails model) {
                ...
                holder.itemView.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        Toast.makeText(PendingOrdersActivity.this, "Order for Table "+model.getTableno(), Toast.LENGTH_LONG).show();
            ...
            public DataViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
                return new DataViewHolder(LayoutInflater.from(PendingOrdersActivity.this).inflate(R.layout.model, viewGroup, false));
            }
        };
